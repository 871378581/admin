...
import com.segama.ege.entity.ShopAdminRoleExample.Criteria;
import com.segama.ege.entity.ShopAdminRoleExample.Criterion;
import com.segama.ege.entity.ShopAdminRoleExample;
import java.util.List;
import java.util.Map;

public class ShopAdminRoleSqlProvider {

    public String countByExample(ShopAdminRoleExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(ShopAdminRoleExample example) {
        BEGIN();
        DELETE_FROM("`shop_admin_role`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ShopAdminRole record) {
        BEGIN();
        INSERT_INTO("`shop_admin_role`");
    ...
    public String selectByExample(ShopAdminRoleExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ShopAdminRole record = (ShopAdminRole) parameter.get("record");
        ShopAdminRoleExample example = (ShopAdminRoleExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(ShopAdminRole record) {
        BEGIN();
        UPDATE("`shop_admin_role`");
    ...
    protected void applyWhere(ShopAdminRoleExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
