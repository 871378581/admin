...
import com.segama.ege.entity.ComplaintSuggestExample.Criteria;
import com.segama.ege.entity.ComplaintSuggestExample.Criterion;
import com.segama.ege.entity.ComplaintSuggestExample;
import java.util.List;
import java.util.Map;

public class ComplaintSuggestSqlProvider {

    public String countByExample(ComplaintSuggestExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(ComplaintSuggestExample example) {
        BEGIN();
        DELETE_FROM("`complaint_suggest`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ComplaintSuggest record) {
        BEGIN();
        INSERT_INTO("`complaint_suggest`");
        
        if (record.getUser_name() != null) {
            VALUES("`user_name`", "#{user_name,jdbcType=VARCHAR}");
        }
        
        if (record.getSuggest_desc() != null) {
            VALUES("`suggest_desc`", "#{suggest_desc,jdbcType=VARCHAR}");
        }
        ...
        if (record.getRespond_message() != null) {
            VALUES("`respond_message`", "#{respond_message,jdbcType=VARCHAR}");
        }
        
        if (record.getProcess_time() != null) {
            VALUES("`process_time`", "#{process_time,jdbcType=TIMESTAMP}");
        }
    ...
    public String selectByExample(ComplaintSuggestExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ComplaintSuggest record = (ComplaintSuggest) parameter.get("record");
        ComplaintSuggestExample example = (ComplaintSuggestExample) parameter.get("example");
        ...
        if (record.getSuggest_desc() != null) {
            SET("`suggest_desc` = #{record.suggest_desc,jdbcType=VARCHAR}");
        }
        ...
        if (record.getRespond_message() != null) {
            SET("`respond_message` = #{record.respond_message,jdbcType=VARCHAR}");
        }
        
        if (record.getProcess_time() != null) {
            SET("`process_time` = #{record.process_time,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByPrimaryKeySelective(ComplaintSuggest record) {
        BEGIN();
        UPDATE("`complaint_suggest`");
        ...
        if (record.getSuggest_desc() != null) {
            SET("`suggest_desc` = #{suggest_desc,jdbcType=VARCHAR}");
        }
        ...
        if (record.getRespond_message() != null) {
            SET("`respond_message` = #{respond_message,jdbcType=VARCHAR}");
        }
        
        if (record.getProcess_time() != null) {
            SET("`process_time` = #{process_time,jdbcType=TIMESTAMP}");
        }
    ...
    protected void applyWhere(ComplaintSuggestExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
