...
import com.segama.ege.entity.AdminUserRoleRelationExample.Criteria;
import com.segama.ege.entity.AdminUserRoleRelationExample.Criterion;
import com.segama.ege.entity.AdminUserRoleRelationExample;
import java.util.List;
import java.util.Map;

public class AdminUserRoleRelationSqlProvider {

    public String countByExample(AdminUserRoleRelationExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(AdminUserRoleRelationExample example) {
        BEGIN();
        DELETE_FROM("`admin_user_role_relation`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(AdminUserRoleRelation record) {
        BEGIN();
        INSERT_INTO("`admin_user_role_relation`");
    ...
    public String selectByExample(AdminUserRoleRelationExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        AdminUserRoleRelation record = (AdminUserRoleRelation) parameter.get("record");
        AdminUserRoleRelationExample example = (AdminUserRoleRelationExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(AdminUserRoleRelation record) {
        BEGIN();
        UPDATE("`admin_user_role_relation`");
    ...
    protected void applyWhere(AdminUserRoleRelationExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
