...
import com.segama.ege.entity.ReportItemExample.Criteria;
import com.segama.ege.entity.ReportItemExample.Criterion;
import com.segama.ege.entity.ReportItemExample;
import java.util.List;
import java.util.Map;

public class ReportItemSqlProvider {

    public String countByExample(ReportItemExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("`report_item`");
    ...
    public String deleteByExample(ReportItemExample example) {
        BEGIN();
        DELETE_FROM("`report_item`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ReportItem record) {
        BEGIN();
        INSERT_INTO("`report_item`");
        
        if (record.getEach_item() != null) {
            VALUES("`each_item`", "#{each_item,jdbcType=VARCHAR}");
        }
        
        if (record.getEach_value() != null) {
            VALUES("`each_value`", "#{each_value,jdbcType=VARCHAR}");
        }
        ...
        if (record.getFather_item_id() != null) {
            VALUES("`father_item_id`", "#{father_item_id,jdbcType=BIGINT}");
        }
        
        return SQL();
    }

    public String selectByExample(ReportItemExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ReportItem record = (ReportItem) parameter.get("record");
        ReportItemExample example = (ReportItemExample) parameter.get("example");
        ...
        if (record.getEach_value() != null) {
            SET("`each_value` = #{record.each_value,jdbcType=VARCHAR}");
        }
        ...
        if (record.getFather_item_id() != null) {
            SET("`father_item_id` = #{record.father_item_id,jdbcType=BIGINT}");
        }
    ...
    public String updateByPrimaryKeySelective(ReportItem record) {
        BEGIN();
        UPDATE("`report_item`");
        ...
        if (record.getEach_value() != null) {
            SET("`each_value` = #{each_value,jdbcType=VARCHAR}");
        }
        ...
        if (record.getFather_item_id() != null) {
            SET("`father_item_id` = #{father_item_id,jdbcType=BIGINT}");
        }
    ...
    protected void applyWhere(ReportItemExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
