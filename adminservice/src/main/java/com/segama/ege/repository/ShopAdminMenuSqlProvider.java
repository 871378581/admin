...
import com.segama.ege.entity.ShopAdminMenuExample.Criteria;
import com.segama.ege.entity.ShopAdminMenuExample.Criterion;
import com.segama.ege.entity.ShopAdminMenuExample;
import java.util.List;
import java.util.Map;

public class ShopAdminMenuSqlProvider {

    public String countByExample(ShopAdminMenuExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(ShopAdminMenuExample example) {
        BEGIN();
        DELETE_FROM("`shop_admin_menu`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ShopAdminMenu record) {
        BEGIN();
        INSERT_INTO("`shop_admin_menu`");
    ...
    public String selectByExample(ShopAdminMenuExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ShopAdminMenu record = (ShopAdminMenu) parameter.get("record");
        ShopAdminMenuExample example = (ShopAdminMenuExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(ShopAdminMenu record) {
        BEGIN();
        UPDATE("`shop_admin_menu`");
    ...
    protected void applyWhere(ShopAdminMenuExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
