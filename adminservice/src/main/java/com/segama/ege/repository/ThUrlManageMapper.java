...
public interface ThUrlManageMapper {
    ...
    @Insert({
        "insert into `th_url_manage` (`business_name`, `open_ticket_main_body`, ",
        ...
        "values (#{business_name,jdbcType=VARCHAR}, #{open_ticket_main_body,jdbcType=VARCHAR}, ",
    ...
    @Select({
        "select",
        "`id`, `business_name`, `open_ticket_main_body`, `product_name`, `product_code`, ",
        "`product_type`, `product_qudao_code`, `url`, `url_status`, `biz_line`, `channel_code`, ",
        "`youxiao_time`, `gmt_create`, `gmt_modify`, `creator_account`, `modifier_account`, ",
        "`description`",
        "from `th_url_manage`",
        "where `id` = #{id,jdbcType=BIGINT}"
    })
