...
public class CacheService {
    ...
    static {
        ...
        cacheMap.put(SYSTEM_IMAGE_LOCATION, "/root/ege/egecarservice/repo");
        cacheMap.put(SYSTEM_IMAGE_REPO_PREFIX, "/egecarservice/repo/");
        ...
        cacheMap.put("login.auth.redirect.default", "/egecarservice/h5/merchant/redirect.html");
        cacheMap.put("login.auth.redirect.abc", "/egecarservice/h5/merchant/redirect.html");
    }
