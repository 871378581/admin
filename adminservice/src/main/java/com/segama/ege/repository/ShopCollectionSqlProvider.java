...
import com.segama.ege.entity.ShopCollectionExample.Criteria;
import com.segama.ege.entity.ShopCollectionExample.Criterion;
import com.segama.ege.entity.ShopCollectionExample;
import java.util.List;
import java.util.Map;

public class ShopCollectionSqlProvider {

    public String countByExample(ShopCollectionExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(ShopCollectionExample example) {
        BEGIN();
        DELETE_FROM("`shop_collection`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ShopCollection record) {
        BEGIN();
        INSERT_INTO("`shop_collection`");
        ...
        if (record.getGmt_collect() != null) {
            VALUES("`gmt_collect`", "#{gmt_collect,jdbcType=TIMESTAMP}");
        }
    ...
    public String selectByExample(ShopCollectionExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ShopCollection record = (ShopCollection) parameter.get("record");
        ShopCollectionExample example = (ShopCollectionExample) parameter.get("example");
        ...
        if (record.getGmt_collect() != null) {
            SET("`gmt_collect` = #{record.gmt_collect,jdbcType=TIMESTAMP}");
        }
    ...
    public String updateByPrimaryKeySelective(ShopCollection record) {
        BEGIN();
        UPDATE("`shop_collection`");
        ...
        if (record.getGmt_collect() != null) {
            SET("`gmt_collect` = #{gmt_collect,jdbcType=TIMESTAMP}");
        }
    ...
    protected void applyWhere(ShopCollectionExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
