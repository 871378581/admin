...
import com.segama.ege.entity.ShopOilSupplyExample.Criteria;
import com.segama.ege.entity.ShopOilSupplyExample.Criterion;
import com.segama.ege.entity.ShopOilSupplyExample;
import java.util.List;
import java.util.Map;

public class ShopOilSupplySqlProvider {

    public String countByExample(ShopOilSupplyExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(ShopOilSupplyExample example) {
        BEGIN();
        DELETE_FROM("`shop_oil_supply`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ShopOilSupply record) {
        BEGIN();
        INSERT_INTO("`shop_oil_supply`");
    ...
    public String selectByExample(ShopOilSupplyExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ShopOilSupply record = (ShopOilSupply) parameter.get("record");
        ShopOilSupplyExample example = (ShopOilSupplyExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(ShopOilSupply record) {
        BEGIN();
        UPDATE("`shop_oil_supply`");
    ...
    protected void applyWhere(ShopOilSupplyExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
