 ...
 */
@RestController
@RequestMapping("/ege/api/shop_admin/shop_oil_supply")
@CrossOrigin(origins = "*", maxAge = 3600)
public class ShopOilSupplyShopController {
    ...
    private static Logger LOG = LoggerFactory.getLogger(ShopOilSupplyShopController.class);
    ...
    public BaseVO add(@RequestParam("shop_id") Long shop_id,
        ...
        try {
            ...
            if(e!=null && JSON.toJSONString(e).contains("DuplicateKeyException")){
                return BaseVO.createFailure("请勿重复添加！");
            }
            LOG.error("ShopOilSupplyShopController#add Exception",e);
            baseVO  = BaseVO.createFailure("添加异常"+ JSON.toJSONString(e));
        }
        return baseVO;
    }
