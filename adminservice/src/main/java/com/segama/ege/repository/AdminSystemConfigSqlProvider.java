...
import com.segama.ege.entity.AdminSystemConfigExample.Criteria;
import com.segama.ege.entity.AdminSystemConfigExample.Criterion;
import com.segama.ege.entity.AdminSystemConfigExample;
import java.util.List;
import java.util.Map;

public class AdminSystemConfigSqlProvider {

    public String countByExample(AdminSystemConfigExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(AdminSystemConfigExample example) {
        BEGIN();
        DELETE_FROM("`admin_system_config`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(AdminSystemConfig record) {
        BEGIN();
        INSERT_INTO("`admin_system_config`");
    ...
    public String selectByExample(AdminSystemConfigExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        AdminSystemConfig record = (AdminSystemConfig) parameter.get("record");
        AdminSystemConfigExample example = (AdminSystemConfigExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(AdminSystemConfig record) {
        BEGIN();
        UPDATE("`admin_system_config`");
    ...
    protected void applyWhere(AdminSystemConfigExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
