...
import com.segama.ege.entity.HotRecommendExample.Criteria;
import com.segama.ege.entity.HotRecommendExample.Criterion;
import com.segama.ege.entity.HotRecommendExample;
import java.util.List;
import java.util.Map;

public class HotRecommendSqlProvider {

    public String countByExample(HotRecommendExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("`hot_recommend`");
    ...
    public String deleteByExample(HotRecommendExample example) {
        BEGIN();
        DELETE_FROM("`hot_recommend`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(HotRecommend record) {
        BEGIN();
        INSERT_INTO("`hot_recommend`");
    ...
    public String selectByExample(HotRecommendExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        HotRecommend record = (HotRecommend) parameter.get("record");
        HotRecommendExample example = (HotRecommendExample) parameter.get("example");
    ...
    public String updateByPrimaryKeySelective(HotRecommend record) {
        BEGIN();
        UPDATE("`hot_recommend`");
    ...
    protected void applyWhere(HotRecommendExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
