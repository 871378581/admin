...
import com.segama.ege.entity.ThPhotosManageExample.Criteria;
import com.segama.ege.entity.ThPhotosManageExample.Criterion;
import com.segama.ege.entity.ThPhotosManageExample;
import java.util.List;
import java.util.Map;

public class ThPhotosManageSqlProvider {

    public String countByExample(ThPhotosManageExample example) {
        BEGIN();
        SELECT("count(*)");
    ...
    public String deleteByExample(ThPhotosManageExample example) {
        BEGIN();
        DELETE_FROM("`th_photos_manage`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(ThPhotosManage record) {
        BEGIN();
        INSERT_INTO("`th_photos_manage`");
        
        if (record.getPhoto_name() != null) {
            VALUES("`photo_name`", "#{photo_name,jdbcType=VARCHAR}");
        }
        
        if (record.getPhoto_code() != null) {
            VALUES("`photo_code`", "#{photo_code,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(ThPhotosManageExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        ThPhotosManage record = (ThPhotosManage) parameter.get("record");
        ThPhotosManageExample example = (ThPhotosManageExample) parameter.get("example");
        ...
        if (record.getPhoto_name() != null) {
            SET("`photo_name` = #{record.photo_name,jdbcType=VARCHAR}");
        }
        
        if (record.getPhoto_code() != null) {
            SET("`photo_code` = #{record.photo_code,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(ThPhotosManage record) {
        BEGIN();
        UPDATE("`th_photos_manage`");
        ...
        if (record.getPhoto_code() != null) {
            SET("`photo_code` = #{photo_code,jdbcType=VARCHAR}");
        }
    ...
    protected void applyWhere(ThPhotosManageExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
