...
import com.segama.ege.entity.SettleConfigExample.Criteria;
import com.segama.ege.entity.SettleConfigExample.Criterion;
import com.segama.ege.entity.SettleConfigExample;
import java.util.List;
import java.util.Map;

public class SettleConfigSqlProvider {

    public String countByExample(SettleConfigExample example) {
        BEGIN();
        SELECT("count(*)");
        FROM("`settle_config`");
    ...
    public String deleteByExample(SettleConfigExample example) {
        BEGIN();
        DELETE_FROM("`settle_config`");
        applyWhere(example, false);
        return SQL();
    }

    public String insertSelective(SettleConfig record) {
        BEGIN();
        INSERT_INTO("`settle_config`");
        
        if (record.getCard_level() != null) {
            VALUES("`card_level`", "#{card_level,jdbcType=INTEGER}");
        }
        
        if (record.getFee() != null) {
            VALUES("`fee`", "#{fee,jdbcType=VARCHAR}");
        }
    ...
    public String selectByExample(SettleConfigExample example) {
        BEGIN();
    ...
    public String updateByExampleSelective(Map<String, Object> parameter) {
        SettleConfig record = (SettleConfig) parameter.get("record");
        SettleConfigExample example = (SettleConfigExample) parameter.get("example");
        ...
        if (record.getCard_level() != null) {
            SET("`card_level` = #{record.card_level,jdbcType=INTEGER}");
        }
        
        if (record.getFee() != null) {
            SET("`fee` = #{record.fee,jdbcType=VARCHAR}");
        }
    ...
    public String updateByPrimaryKeySelective(SettleConfig record) {
        BEGIN();
        UPDATE("`settle_config`");
    ...
    protected void applyWhere(SettleConfigExample example, boolean includeExamplePhrase) {
        if (example == null) {
            return;
        }
